...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Whether screenshot sound should be played.
         * Default 1.
         * @hide
         */
    ...
    public static final class Secure extends NameValueTable {
         ...
         * Either FLAMINGO_VOLUME_HUSH_OFF or a comma separated list of modes. One or more of:
         * FLAMINGO_VOLUME_HUSH_NORMAL, FLAMINGO_VOLUME_HUSH_VIBRATE, FLAMINGO_VOLUME_HUSH_MUTE
         * @hide
         */
        @SystemApi
        @Readable
        ...
        /** @hide */
        public static final String FLAMINGO_VOLUME_HUSH_OFF = "off";
        /** @hide */
        public static final String FLAMINGO_VOLUME_HUSH_NORMAL = "normal";
        /** @hide */
        public static final String FLAMINGO_VOLUME_HUSH_VIBRATE = "vibrate";
        /** @hide */
        public static final String FLAMINGO_VOLUME_HUSH_MUTE = "mute";
        ...
        /**
         * Whether to link ringtone and notification volume.
         * Default 1.
         * @hide
         */
