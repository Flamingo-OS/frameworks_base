...
public class NotificationIconContainer extends AlphaOptimizedFrameLayout {
    ...
    private final int MAX_ICONS_ON_AOD =
            getResources().getInteger(R.integer.config_maxVisibleNotificationIconsOnAOD);
    ...
    private final int MAX_ICONS_ON_LOCKSCREEN =
            getResources().getInteger(R.integer.config_maxVisibleNotificationIconsOnLockscreen);
