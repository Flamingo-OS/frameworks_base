...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void unionViewBoundstoTouchableRegion(final View view) {
        ...
        if (mController.isVolumePanelOnLeft()) {
            mTouchableRegion.op(
                    locInWindow[0],
    ...
    private void initDialog(int lockTaskModeState) {
        ...
        if (!mShowActiveStreamOnly) {
            ...
            lp.gravity |= mController.isVolumePanelOnLeft() ? Gravity.LEFT : Gravity.RIGHT;
        }
        ...
        mDialogView.setLayoutDirection(mController.isVolumePanelOnLeft()
    ...
    private void setupRingerDrawer() {
        ...
        } else if (mController.isVolumePanelOnLeft()) {
            mDialogView.setPadding(
                    mDialogView.getPaddingLeft(),
                    mDialogView.getPaddingTop(),
    ...
    private float getTranslationForPanelLocation() {
        return mController.isVolumePanelOnLeft() ? -1 : 1;
    }
    ...
    public void initSettingsH(int lockTaskModeState) {
    ...
    private void updateRowsH(final VolumeRow activeRow, boolean animate) {
        ...
        final boolean isOutmostIndexMax = mController.isVolumePanelOnLeft() ? isRtl() : !isRtl();
    ...
    private void setTopContainerBackgroundDrawable() {
        ...
        background.setLayerGravity(
                0, Gravity.TOP | (mController.isVolumePanelOnLeft() ? Gravity.LEFT : Gravity.RIGHT));
