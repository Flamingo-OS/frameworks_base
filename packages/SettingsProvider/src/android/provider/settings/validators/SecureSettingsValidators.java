...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.VOLUME_HUSH_GESTURE,
                new Validator() {
                    ...
                    public boolean validate(String value) {
                        ...
                        if (value.equals(Secure.FLAMINGO_VOLUME_HUSH_OFF))
                            return true;
                        String[] args = value.split(",", 0);
                        for (String str : args) {
                            if (!str.equals(Secure.FLAMINGO_VOLUME_HUSH_NORMAL) ||
                                !str.equals(Secure.FLAMINGO_VOLUME_HUSH_MUTE) ||
                                !str.equals(Secure.FLAMINGO_VOLUME_HUSH_VIBRATE)
                            ) return false;
                        }
                        return true;
                    }
        ...
        VALIDATORS.put(Secure.COMBINED_STATUS_BAR_SIGNAL_ICONS, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.FORCE_FULLSCREEN_CUTOUT_APPS, APP_LIST_VALIDATOR);
    }
}
